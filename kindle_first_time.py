...
while doneCount<appCount:
    ...
    print("Apps installed " + str(doneCount) + " out of " + str(appCount))
    
print("app installs complete, finalizing some things...")
devNum=0
...
while devNum < len(devList):
    os.system('adb -s '  + devList[devNum] + ' shell pm grant com.google.android.gms android.permission.INTERACT_ACCROSS_USERS')
    os.system('adb -s '  + devList[devNum] + ' shell pm clear com.amazon.kindle.kso')
    os.system('adb -s '  + devList[devNum] + ' shell pm hide com.amazon.kindle.kso')
    devNum=0
...
print("completed, " + str(appCount) + " apps installed on your devices and first time setup completed.")
print("please review the installation process to ensure that there were no failures or error messages.")
